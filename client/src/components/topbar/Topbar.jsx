...
export default function Topbar() {
  ...
  return (
    <header className="h-16 md:h-20 bg-slate-900/80 backdrop-blur-md border-b border-white/5 px-4 md:px-8 flex items-center justify-between sticky top-0 z-50">
      ...
      {/* RIGHT SECTION: UTILITIES, PROFILE & HAMBURGER */}
      <div className="flex items-center gap-2 md:gap-6">
        ...
        >
          <div className="flex items-center gap-3 pl-6 border-l border-white/10 cursor-pointer py-2 group">
            <div className="text-right">
              <p className="text-sm font-bold text-white leading-none capitalize">{userRole || "User"}</p>
              <p className="text-[10px] text-slate-500 mt-1 font-medium">Verified Session</p>
            </div>
        ...
        {/* HAMBURGER MENU (Far Right, Mobile Only) */}
        <button 
          ...
          >
            <div className="p-4 flex flex-col gap-1">
              ...
              <div className="flex items-center gap-4 p-4 mb-2 bg-slate-800/50 rounded-2xl border border-white/5">
                ...
                <div>
                  <p className="text-white font-bold capitalize">{userRole || "User"}</p>
